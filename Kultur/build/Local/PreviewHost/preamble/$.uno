...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("77.238.50.212"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124)}, "C:\\Users\\viktorlaptop\\Documents\\Fuse\\Kultur\\FacebookLogin.unoproj", GetBundle, new string[] { ""})
{
...
{
return Uno.IO.Bundle.Get("FacebookLogin");
}
}
}
